<!-- this is get post tutorial in php -->
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="/cwdphp/21_get_post.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<?php
  ...
  //connecting to the database
   ...
   if(!$conn){
    ...
    <strong>Error!</strong> We are facing some technical issue and Your entry was not submitted successfully! We 
...
<h1>Contact us for your concerns</h1>
  <form action="/cwdphp/28_form.php" method="post">
